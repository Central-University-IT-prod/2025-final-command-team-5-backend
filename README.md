...
* backend - [backend](https://REDACTED/team-5/backend#bookingit)
* frontend - [frontend](https://REDACTED/team-5/frontend#spacery-frontend)
...
Ознакомьтесь с документацией по API, используя [этот линк](https://prod-team-5-qnkvbg7c.REDACTED/api/doc/swagger). Документация представлена в формате Swagger, что облегчает понимание работы эндпоинтов, их параметров и примеров запросов/ответов.
